        ...
        <div class="col-12 col-sm-8 col-md-6">
            <form class="form mt-5" action="{{route('register.store')}}" method="post">
                ...
                <div class="form-group">
                    <label for="firstname" class="text-dark">Firstname:</label><br>
                ...
                <div class="form-group mt-3">
                    <label for="middlename" class="text-dark">Middlename:</label><br>
                ...
                <div class="form-group mt-3">
                    <label for="lastname" class="text-dark">Lastname:</label><br>
